...
- Add a Standard week accrual timing hint that suggests the earliest leave start date when a request would otherwise exceed accrued leave, and keep this hint out of printed PDFs.
